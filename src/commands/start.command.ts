...
По любым вопросам — напишите [нам](@adswap_admin) 👈

Регистрируясь на платформе, вы даете согласие на обработку персональных данных, а также подтверждаете ознакомление с [пользовательским соглашением](https://adswap.ru/privacy) и политикой конфиденциальности[политикой конфиденциальности](https://adswap.ru/agreement)\\.
`, {
                reply_markup: {
                    inline_keyboard: [
